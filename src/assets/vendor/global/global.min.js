...
var body = $("body")
  , html = $("html");
function dlabSettings({typography: a, version: t, layout: r, navheaderBg: e, headerBg: o, sidebarStyle: d, sidebarBg: b, sidebarPosition: i, headerPosition: c, containerLayout: s, direction: l, primary: y}) {
...
dlabSettings.prototype.manageLayout = function() {
    switch (this.layout) {
    case "horizontal":
        "overlay" === this.sidebarStyle ? body.attr("data-sidebar-style", "full") : body.attr("data-sidebar-style", `${this.sidebarStyle}`),
...
dlabSettings.prototype.manageContainerLayout = function() {
    ...
    case "boxed":
        "vertical" === this.layout && "full" === this.sidebarStyle && body.attr("data-sidebar-style", "overlay"),
...
dlabSettings.prototype.manageResponsiveSidebar = function() {
    ...
    a < 1024 && (body.attr("data-layout", "vertical"),
    body.attr("data-container", "wide")),
